...
public class ReconcilableBuildPipelineRuleTests
{
    ...
    public async Task ReconcileAndEvaluateAsyncResult_Equals_EvaluateAsyncResult()
    {
        ...
        var reconcilableRule = new ReconcilableBuildPipelineRuleImplementation(_azdoClientMock.Object, evaluationResult);
