...
public class HttpPutRequestTestImplementation : HttpPutRequest<ITestHttpClientCallHandler, object, object>
{
    public HttpPutRequestTestImplementation(object value, ITestHttpClientCallHandler callHandler) : base(value, callHandler) { }
