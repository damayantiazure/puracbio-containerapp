...
param productName string = 'compliance-product'
param apiName string = 'compliance-api'
...
param description string = 'Compliance Web API'
param displayName string = 'Compliance Web API'
