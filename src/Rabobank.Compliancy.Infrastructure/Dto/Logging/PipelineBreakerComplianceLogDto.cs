...
public class PipelineBreakerComplianceLogDto : LogModelDtoBase
{
    ...
    [Display(Name = "Approver_s")]
    public string? Approver { get; set; }

    [Display(Name = "ExclusionReasonApprover_s")]
    public string? ExclusionReasonApprover { get; set; }

    [Display(Name = "IsExcluded_b")]
    public bool IsExcluded { get; set; }

    [Display(Name = "Requester_s")]
    public string? Requester { get; set; }

    [Display(Name = "ExclusionReasonRequester_s")]
    public string? ExclusionReasonRequester { get; set; }

    [Display(Name = "RuleCompliancyReports_s")]
    public IEnumerable<RuleCompliancyLogDto>? RuleCompliancyReports { get; set; }
    ...
    [Display(Name = "HasCorrectRetention_s")]
    public string? HasCorrectRetention { get; set; }
