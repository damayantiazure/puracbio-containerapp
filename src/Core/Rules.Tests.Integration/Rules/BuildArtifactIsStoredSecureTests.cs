...
public class BuildArtifactIsStoredSecureTests : IClassFixture<TestConfig>
{
    ...
    public BuildArtifactIsStoredSecureTests(TestConfig config)
    {
        _config = config;
    ...
    public async Task EvaluateBuildIntegrationTest(string pipelineId, bool expectedResult)
    {
        ...
        var rule = new BuildArtifactIsStoredSecure(_client, _cache, _yamlHelper);
